...
const checkProcEqualTypes = (te1: T.NewProcTExp, te2: T.NewProcTExp, exp: A.Exp): Result<true> =>
...
export const typeofProc = (proc: A.NewProcExp, tenv: E.TEnv): Result<T.TExp> => {
