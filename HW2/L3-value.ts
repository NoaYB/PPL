...
export const makeClass = (fields: VarDecl[], methods: Binding[], env: Env): Class =>
    ({tag: "Class", fields: fields, methods: methods, env});

export const makeObject = (c: Class, values: Value[]): Object =>
    ({tag: "Object", class: c, values: values });
...
export type LitSExp = number | boolean | string | Class | Object | SymbolSExp | EmptySExp | CompoundSExp;
